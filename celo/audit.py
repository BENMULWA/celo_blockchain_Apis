...
withdrawals, gas top-ups, sweeps, blocked limits. Kept separate from
`celo_ledger_entries` (business records meant for partner-facing history) so
a security review or incident investigation doesn't depend on
business-logic bookkeeping staying consistent; this log's only job is
"what did we sign and broadcast, and why."
"""
import uuid
